// Pixel-perfect Next.js conversion of the Stitch "Errors" screen
                ...
                <div className="flex flex-col flex-1">
                  <div className="flex items-center justify-between border-b border-surface-container/30">
                    <div className="flex gap-8">
                      <button className="pb-4 text-sm font-semibold text-[#00426d] border-b-2 border-amber-400">Crucial</button>
                      <button className="pb-4 text-sm font-medium text-slate-400 hover:text-[#00426d] transition-colors">All</button>
                    </div>
